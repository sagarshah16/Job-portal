		   ...
		   <?php
			...
			if (mysql_num_rows($res)>0)
			{
				...
				while ($row = mysql_fetch_array($res))
				{
					...
					echo "\t\t\t\t<td width='3%'><input type='submit' name='edit' style='border:none;  cursor:pointer;  background:none; background-image:url(Images/message.png); width:26px; height:26px' value='' /></td>\n";
					echo "\t\t\t</form>\n";
					echo "\t\t\t<form action='adminmessagedeleteinbox.php?id=$id_message' method='post'>\n";
					//echo "<input type='hidden' name='id_message' value='$id_message' />";
					echo "<input type='hidden' name='inbox' value='inbox' />";
					echo "\t\t\t\t<td width='3%' align='center'><input type='submit' name='deletemessage' style='border:none;  cursor:pointer;  background:none; background-image:url(Images/delete.png); width:16px; height:16px' value='' /></td>\n";
					echo "\t\t\t</form>\n";
					echo "\t\t\t<form action='adminmessageblockunblockusers.php?id=$id_message' method='post'>\n";
