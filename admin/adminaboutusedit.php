...
if (!isset($_SESSION['username'])) 
	...
	if($res=$db->send_sql($query))
	{
		if (mysql_num_rows($res)>0)
		{
			...
			{
				$aboutus=stripslashes($row["aboutus"]);
            ...
            <tr>
                <td>
					<ul>
						...
						<li><a href="adminaboutusedit.php" style="font-size:12px; font-weight:bold; cursor:pointer; color:#000;" onClick="">About Us</a></li>
					</ul>
                </td>
            </tr>   
            <tr>
      ...
      <div style="float:left; width:70%; background-color:#FFF">
      	<div style="padding:10px">
             ...
             <form action="admincontentpagessave.php" name="frmupload" method="post" enctype="multipart/form-data" onSubmit="return validate();">
               <input type="hidden" name="aboutsave" value="about">
             ...
             <tr>
				...
				?>
                      ...
                      <tr>    <td style="width:150px; vertical-align:text-top"><label style="font-weight:bold">About Us:</label><label style="color:red; font-weight:bold">*</label></td></tr>
             
             <tr>
            
                <td><textarea name="aboutus" id="aboutus" cols="80" rows="25" ><?php if(isset($aboutus)) echo $aboutus;?></textarea></td>
             </tr>
