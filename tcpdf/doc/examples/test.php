...
<div style="float:left; width:70%; background-color:#FFF">
        ...
        <hr size="1" color="#069"  align="center">
	         <h2>Create Resume</h2>
        <hr size="1" color="#069"  align="center">
             <form action="example_002.php" name="frmupload" method="post" enctype="multipart/form-data">
            ...
            <tr>
				<td colspan="2"> <textarea name="objective" id="objective" rows="4" cols="80" value=""><?php if(isset($objective) && $objective!="")echo $objective;?></textarea> </td>
			</tr>
            </tr>
            <tr><td colspan="2">&nbsp;</td></tr>
            <tr>
