...
include("admin/Class_Database.php");
$db= new database();
//$db->setup("kaushal", "kaushal", "localhost", "jobportaldb");	

if (isset($id) && isset($id_message))
{
	$query="Delete from admin_message where id_message=$id_message and id_user=$id";
	if ($res=$db->send_sql($query))
	{
		echo "<h2>Message Deleted Successfully!</h2>";
		echo "<a href='jsinbox.php' class='button'>Back</a>  ";
	}
}
