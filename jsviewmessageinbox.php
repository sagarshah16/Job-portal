		   ...
		   <?php
				...
				else
			{
				...
				echo"<table width='100%' cellpadding='2' cellspacing='0' border='0' style='font-family:Verdana, Geneva, sans-serif; font-size:12px'>";					
					echo "\t\t\t<form action='jsviewmessageinbox.php' method='post'>\n";
				...
				{
				echo "<td width='25%' style='background-color:#CCC; '><a href='jssendmessage.php' class='button' style='border:none; cursor:pointer; padding:5px;  float:right; '>Reply</a> <a class='button' style='border:none; cursor:pointer; padding:5px;  float:right;' onClick='javascript:history.back();'>Back</a></td> ";
